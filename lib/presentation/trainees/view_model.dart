...
class TraineesViewModel extends TraineesViewModelOutput {
  ...
  Future getTraineesData() async {
    ...
    (await _useCase.execute(Void)).fold((l) {
      ...
      if (r.isEmpty) {
        inputState.add(EmptyState(message: 'لايوجد متدربين حتي الان'));
      } else {
        inputFilteredData.add(filteredData);
  ...
  void setSearch(String search) {
    if (search.isNotEmpty) {
      ...
      filteredData = originalData; // Clear filteredData if search is empty
    }
  ...
  @override
  Stream<List<TraineeData>> get outFilteredData =>
...
abstract class TraineesViewModelInput extends BaseViewModel {
...
abstract class TraineesViewModelOutput extends TraineesViewModelInput {
